                ...
                <div class="col-lg-6 col-md-12 col-6 mb-4">
                    <div class="card">
                        <div class="card-body text-center">
                            <span class="fw-semibold d-block mb-3">Total User</span>
                            <h3 class="card-title mb-2">8</h3>
                            <a href="{{ route('admin.user') }}" class="text-gray small "> View All </a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-6 col-md-12 col-6 mb-4">
                    <div class="card">
                        <div class="card-body text-center">
                            <span class="fw-semibold d-block mb-3">Total Admin</span>
                            <h3 class="card-title mb-2">8</h3>
                            <a href="{{ route('adminPanel') }}" class="text-gray small "> View All </a>
                        </div>
                    </div>
                </div>
            </div>
